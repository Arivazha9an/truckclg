...
import 'package:truckclgproject/BharathBenz/screens/updateforms/updatedriver.dart';
...
class Driverretrieve extends StatefulWidget {
  ...
  @override
  State<Driverretrieve> createState() => _DriverretrieveState();
}

class _DriverretrieveState extends State<Driverretrieve> {
              ...
              children: [
                ...
                pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text('Expires: ${data['Expires'] ?? ''}'),
                    pw.Text('Blood Group: ${data['Blood Group'] ?? ''}'),
