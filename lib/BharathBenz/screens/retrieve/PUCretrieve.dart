import 'dart:io';
import 'package:truckclgproject/BharathBenz/screens/updateforms/pucupdate.dart';
...
class Pucretrieve extends StatefulWidget {
  @override
  State<Pucretrieve> createState() => _PucretrieveState();
}

class _PucretrieveState extends State<Pucretrieve> {
            ...
            return pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Text('PUC Number: ${data['PUC Number'] ?? ''}'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'PUC Data', isGoBack: true),
      body: Column(
        children: [
          Padding(
