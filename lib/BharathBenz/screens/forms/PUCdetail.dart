...
class BPUCDetail extends StatefulWidget {
  const BPUCDetail({super.key});

  @override
  State<BPUCDetail> createState() => _PUCDetailState();
}

class _PUCDetailState extends State<BPUCDetail> {
  ...
  Widget build(BuildContext context) {
    void _saveData() async {
      if (_dropController.text.isEmpty &&
        ...
        try {
          await FirebaseFirestore.instance.collection('bharathbenzpuc').add({
